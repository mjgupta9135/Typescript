...
//To define the type of array we just add [] after data type
...
const res = maxValue([12, 34, 54, 23]);
console.log("Max value is:- " + res);

//We can define data type with help of type
...
const res2 = maxValue2([12, 91, 54, 23]);
console.log("Max value is:- " + res2);
//We cannot do this through interface
